...
if strcmp(exp_name,'vol_basic_cubic')
    ...
    save_name = [exp_name '_speech_RTF.mat'];
end
...
if par_calc
    room_speech_RTF_list = rir2speech2RTF( room_rir_list,room_list,speech_file,save_name,nworkers );
else
    room_speech_RTF_list = rir2speech2RTF( room_rir_list,room_list,speech_file,save_name );
end
